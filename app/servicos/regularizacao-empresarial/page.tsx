...
import { FileCheck, CheckCircle, Phone, Shield, AlertCircle, FileText, Clock, Sparkles } from "lucide-react";
          ...
          <AnimatedSection>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg text-zacon-silver-light">
                Sua empresa com pendências? Resolvemos débitos fiscais, trabalhistas
                e cadastrais para você voltar a operar normalmente.
              </p>
              <div className="mt-8">
